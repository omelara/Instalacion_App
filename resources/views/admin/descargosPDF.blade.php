...
<head>
    ...
    <title>Reporte descargosPDF</title>   
</head>
<body>
<header class="header">
    ...
    <h4 class="report-title">Reporte de Descargos</h4>
    <br>
    <h5 id ="subtitilo_reporte">Periodo del:&nbsp;{{$fecha1}}&nbsp;Al &nbsp; {{$fecha2}}</h5>
        ...
        <table class="table" border="1px">
            ...
            <br>
               <label>Total de descargos en el periodo:</label>&nbsp; <strong>{{$count}}
            <br>
