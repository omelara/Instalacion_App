        ...
        <v-container fluid>
          ...
          >
            <v-row>
              ...
              <v-col cols="12" md="2" class="text-white"><h4>Fecha Préstamo</h4></v-col>
              <v-col cols="12" md="3">
                <date-picker
              ...
              <v-col cols="12" md="4"></v-col>
              <v-col cols="12" md="2" class="text-white"><h4>Fecha Devuelto</h4></v-col>
              <v-col cols="12" md="3">
                <date-picker
                  v-model="prestamoForm.fechaDevuelto"
                  :editable="false"
                  lang="es"
                  value-type="format"
                  format="YYYY-MM-DD"
            ...
            <!--<v-row> 
              <v-col cols="12" md="6">
              <v-text-field
              v-model="prestamoForm.proyecto_origen"
                  :max="prestamoForm.proyecto_origen"
               label="Proyecto Origen"
             ></v-text-field>
             </v-col> 
              <v-col cols="12" md="6">
              <v-text-field
              v-model="prestamoForm.proyecto_destino"
              :min="prestamoForm.proyecto_destino"
              ...
              <v-col cols="12" md="12" lg="12" sm="12">
                <v-card outlined>
                  ...
                  <v-card-text class="bg-black" >
                    <v-data-table 
                      :headers="headerTable"
                      :items="prestamoForm.bodegas"
                      no-data-text="No Hay Nada  Agregado De Bodega"
                      :items-per-page="10"
  ...
  data() {
    return {
      ...
      prestamoForm: {
        id: null,
        correlativo: "",
        //agreaga para fecha devuelto
        fechaDevuelto: new Date(
          Date.now() - new Date().getTimezoneOffset() * 60000
        )
          .toISOString()
          .substr(0, 10),
        ///agregado los proyectos
        //proyecto_origen: "",
        //proyecto_destino: "",
