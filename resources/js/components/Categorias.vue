            ...
            <v-toolbar flat color="white">
              ...
              <v-dialog v-model="dialog" persistent max-width="700px">
                ...
                <v-card>
                  ...
                  <v-card-text>
                    <v-container>
                      <v-form style="background-color:" class="card-header text-center" ref="formCategoria" v-model="validForm" :lazy-validation="true">
                        <v-text-field
        ...
        if(accion=="add"){
            ...
            .catch(function(error){
                if(error.response.status == 409){
                   ...
                   me.errorsNombre = ["Nombre De Categoria Existente", "error"];
                }else{
