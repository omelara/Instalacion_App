          ...
          <template v-slot:top>
            <v-toolbar flat color="white">
               ...
               <div class="flex-grow-1">
                <v-btn small elevation="4" color="#B22222" dark class="mb-2" href="clientes/pdf" target="_blank ">
                  Generar PDF&nbsp;
              ...
              <v-dialog v-model="dialog" persistent max-width="700px">
                ...
                <v-card>
                  ...
                  <v-card-text>
                    <v-container>
                      <v-form  style="background-color:" class="card-header text-center"  ref="formCliente" v-model="validForm" :lazy-validation="true">

                       <v-row>
                         <v-col cols="12" md="6"> 
                         <date-picker
                          v-model="cliente.fecha_registro"
                          :editable="false"
                          lang="es"
                          value-type="format"
                          format="YYYY-MM-DD"
                        ...
                        ></date-picker>
                         ...
                         <v-text-field
                          ...
                          @keyup="errorsNombre = []"  
                           ...
                           v => (v && v.length <= 40) || 'El nombre no debe tener mas de 40 caracteres']"
                          label="Nombre"
                          required
                       ...
                       <v-row>
                         ...
                         <v-text-field
                          ...
                          v => (v && v.length <= 80) || 'El nombre no debe tener mas de 80  caracteres']"
                          label="Dirección"
                          required
                          :error-messages="errorsNombre"
                         ></v-text-field>
        ...
        if(accion=="add"){
            ...
            .catch(function(error){
                if(error.response.status == 409){
                   me.setMessageToSnackBar("Cliente ya existe",true);
                   me.errorsNombre = ["Nombre De Cliente Existente ", "error"];
                }else{
     ...
     verificarAccionDato(cliente, statusCode, accion) {
      ...
      switch (accion) {
        case "add":
          ...
          Toast.fire({
            icon: 'success',
            title: 'Cliente Se Registro Con Exito'
           });
          me.loader = false;
          break;
        case "upd":
          ...
          Toast.fire({
            icon: 'success',
            title: 'Cliente Se Actualizo Con Exito'
           }); 
