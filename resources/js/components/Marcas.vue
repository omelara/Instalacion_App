<!--INICIO-->
  ...
  <v-card dark flat>
    <v-toolbar flat height="72">
     ...
     <!-- campo contenedor para los datos, los afectados por cambio de color del tema-->
            ...
            <v-toolbar flat >
              ...
              <v-dialog v-model="dialog" persistent max-width="700px">
                ...
                <v-card>
                  ...
                  <v-card-text>
                    <v-container>
                      <v-form style="background-color:" class="card-header text-center" ref="formMarca" v-model="validForm" :lazy-validation="true">
                        <v-text-field
        ...
        if(accion=="add"){
            ...
            .catch(function(error){
                if(error.response.status == 409){
                   me.setMessageToSnackBar("La marca ya existe",true);
                   me.errorsNombre = ["Nombre de marca existente", "error"];
                }else{
